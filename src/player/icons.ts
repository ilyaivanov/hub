...
export const playIcon = createIconFromInfo(playIconInfo);

export const pauseIcon = createSvgWithPath(
    320,
    512,
...
export const search = createIconFromInfo(searchIconInfo);

export const profileIconInfo = {
    width: 448,
    height: 512,
...
export const profile = createIconFromInfo(profileIconInfo);

export const listIconInfo = {
    width: 512,
    height: 512,
...
export type IconInfo = typeof listIconInfo;

export const list = createIconFromInfo(listIconInfo);

export const wide = createSvgWithPath(
    448,
    512,
...
export const narrow = createSvgWithPath(
    448,
    512,
...
function createIconFromInfo(info: IconInfo) {
    return createSvgWithPath(info.width, info.height, info.path);
}
